...
const ArknightsChangzhu: ArknightsChizi = {
  star6_up: "塞雷娅/嗟峨".split("/").map(appendStar(6)),
  star6_up_p: .5,
  star6:
    "能天使/推进之王/伊芙利特/艾雅法拉/安洁莉娜/闪灵/夜莺/星熊/银灰/斯卡蒂/陈/黑/赫拉格/麦哲伦/莫斯提马/煌/阿/刻俄柏/风笛/傀影/温蒂/早露/铃兰/棘刺/森蚺/史尔特尔/瑕光/泥岩/山/空弦/异客/凯尔希/卡涅利安/帕拉斯"
      .split("/").map(appendStar(6)),

  star5_up: "食铁兽/灰喉/四月".split("/").map(appendStar(5)),
  star5_up_p: .5,
  star5:
    "白面鸮/凛冬/德克萨斯/芙兰卡/拉普兰德/幽灵鲨/蓝毒/白金/陨星/天火/梅尔/赫默/华法琳/临光/红/雷蛇/可颂/普罗旺斯/守林人/崖心/初雪/真理/空/狮蝎/夜魔/诗怀雅/格劳克斯/星极/送葬人/槐琥/苇草/布洛卡/哞/惊垫/慑砂/巫恋/极境/石棉/月禾/莱恩哈特/断崖/蜜蜡/贯维/安哲拉/燧石/奥斯塔/絮雨/卡夫卡/爱丽丝/乌有/熔泉水/赤冬/绮良"
      .split("/").map(appendStar(5)),
...
const ArknightsHuodong: ArknightsChizi = {
  star6_up: "森蚺".split("/").map(appendStar(6)),
  star6_up_p: .5,
  star6:
    "能天使/推进之王/伊芙利特/艾雅法拉/安洁莉娜/闪灵/夜莺/星熊/塞雷娅/银灰/斯卡蒂/陈/黑/赫拉格/麦哲伦/莫斯提马/煌/阿/刻俄柏/风笛/傀影/温蒂/早露/铃兰/棘刺/史尔特尔/瑕光/泥岩/山/空弦/嗟峨/异客/凯尔希/卡涅利安/帕拉斯"
      .split("/").map(appendStar(6)),

  star5_up: "陨星/燧石".split("/").map(appendStar(5)),
  star5_up_p: .5,
  star5:
    "白面鸮/凛冬/德克萨斯/芙兰卡/拉普兰德/幽灵鲨/蓝毒/白金/天火/梅尔/赫默/华法琳/临光/红/雷蛇/可颂/普罗旺斯/守林人/崖心/初雪/真理/空/狮蝎/食铁兽/夜魔/诗怀雅/格劳克斯/星极/送葬人/槐琥/苇草/布洛卡/灰喉/哞/惊垫/慑砂/巫恋/极境/石棉/月禾/莱恩哈特/断崖/蜜蜡/贯维/安哲拉/四月/奥斯塔/絮雨/卡夫卡/爱丽丝/乌有/熔泉水/赤冬/绮良"
      .split("/").map(appendStar(5)),

  star4_up: "酸糖".split("/").map(appendStar(4)),
  star4_up_p: .2,
  star4:
